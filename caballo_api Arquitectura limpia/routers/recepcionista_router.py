...
from models.models import Cliente, Mascota, Consulta
from entities.schemas import ClienteCreate, ClienteResponse, MascotaCreate, MascotaOut, ConsultaCreate, ConsultaResponse, EstadoUpdate
