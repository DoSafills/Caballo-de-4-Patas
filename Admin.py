...
from CRUD import crear_admin, eliminar_admin_por_rut
from CRUD import crear_veterinario, eliminar_veterinario_por_rut
from CRUD import crear_recepcionista, eliminar_recepcionista_por_rut
