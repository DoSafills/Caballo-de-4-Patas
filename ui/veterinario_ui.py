        ...
        if not mascotas:
            ...
            if selected:
                with st.form("modificar_mascota"):
                    ...
                    sexo_valor = selected.get('sexo', 'Macho')
                    sexo_index = opciones_sexo.index(sexo_valor) if sexo_valor in opciones_sexo else 0
                    ...
                    estado = st.selectbox("Estado Médico", ["Alta", "Pendiente atención", "En tratamiento"],
                                        index=["Alta", "Pendiente atención", "En tratamiento"].index(
                                            selected.get("estado", "Pendiente atención")))
